...
struct QuestionSectionTestData {
  ...
  static let sectionTitle = "Concurrency"
  static let sectionDescription = "Concurrent code in Swift, including async/await, tasks, actors, and more."
  ...
  static let jsonString = """
 {
   ...
   "questions": [{
     ...
     },
     {
       ...
       "answer": "This is when there are multiple CPU's and the different programs can be run on different CPU's. additionally, a single program can spread its processing on multiple CPU's."
     }
   ]
 }
"""
